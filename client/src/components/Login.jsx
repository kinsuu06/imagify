...
const Login = () => {
    ...
    const {setShowLogin, backendURL, setToken, setUser} = useContext(AppContext) // use this variable for cross the login form
  ...
  return (
    <motion.div onSubmit={onSubmitHandler} className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'
