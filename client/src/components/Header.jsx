...
import { motion } from "motion/react";// for transition 
...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col justify-center text-center items-center my-20'
    ...
    viewport={{once:true}}>
        ...
        <motion.button className='sm:text-lg bg-black text-white w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'
